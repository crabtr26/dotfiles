...
plugins=(git git-auto-fetch git-commit gitfast docker history poetry pre-commit python tmux zsh-interactive-cd zsh-autosuggestions zsh-syntax-highlighting colorize z aliases dirhistory copybuffer copyfile copypath)
