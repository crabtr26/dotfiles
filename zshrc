...
plugins=(git git git-auto-fetch git-commit git-prompt gitfast docker history poetry pre-commit python tmux zsh-interactive-cd zsh-autosuggestions zsh-syntax-highlighting)
